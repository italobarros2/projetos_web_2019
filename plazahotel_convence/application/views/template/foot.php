<!-- JS here -->
<a href="https://api.whatsapp.com/send?phone=5588996880964" class="float" target="_blank">
...
<script>
	...
	if (document.getElementById("map")) {
		...
		function init() {
			var mapOptions = {
				zoom: 16,
				center: new google.maps.LatLng(-3.6918568,-40.3519713), // New York
				styles: [{
					"featureType": "water",
			...
			var marker = new google.maps.Marker({
				position: new google.maps.LatLng(-3.6918568,-40.3519713),
				map: map,
				title: 'SD Plaza Hotel'
			});
		}
	}
</script>
