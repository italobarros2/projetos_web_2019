			...
			<div class="row">
				<div class="col-lg-8">
					<div class="fix-device banner_content">
						...
						<p>
							Pós-graduação que utiliza a música e seus elementos para promover a melhoria na condição de saúde,
							no tratamento de pacientes com dificuldades físicas, cognitivas e emocionais.
							Conheça o curso e matricule-se!
						</p>
						...
						<div class="search_course_wrap">
							...
							<form action="<?=base_url('processo')?>" class="form_perso form_box justify-content-between w-100" style="padding: 0px" method="post">
								<ul style="list-style-type: none; padding: 0">
									...
									<input type="hidden" value="3" name="curso">
								</ul>
...
<div class="fact_area_perso fact_area overlay" id="diferencials">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6">
				<div class="single_fact card-perso">
					<div class="f_icon" style="margin-bottom: 18px">
						<img src="<?=base_url('static/img/f-icons/icon4.png')?>" style="position: relative; bottom:5px" alt="">
					</div>
					<h4 style="color: #08A0AD">Conhecimento e Habilidades</h4>
					<p>Com duração de 24 meses e com carga horária de 460h/a, o curso traz uma Matriz Curricular mescla disciplinas da área da música e psicologia.</p>
				</div>
			</div>
			<!-- single features -->
			<div class="col-lg-4 col-md-6">
				<div class="single_fact card-perso">
					...
					<h4 style="color: #884BAB">Aprenda estratégias</h4>
					<p>Com as habilidades adquiridas na pós-graduação, você terá capacidade de trabalhar com reabilitação física, mental e social dos indivíduos.</p>
				</div>
			</div>

		</div>
		<div class="row justify-content-center" id="disciplines" style="margin-top: 50px">
			<div class="col-lg-6">
				<div class="main_title">
			...
			<table class="table" style="margin-bottom: 50px; text-transform: uppercase;">
				...
				<tr>
					<th scope="row">01</th>
					<td>Princípios e Fundamentos da Musicoterapia</td>
				...
				<tr>
					<th scope="row">03</th>
					<td>Voz: Canto e Recursos da fala</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">04</th>
					<td>Neurociências e Música</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">05</th>
					<td>Psicologia do desenvolvimento</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">06</th>
					<td>Vivências Musicoterápicas I</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">07</th>
					<td>Musicoterapia – Áreas de atuação e aplicação I</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">08</th>
					<td>Psicologia diferencial da personalidade e da inteligência</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">09</th>
					<td>Psicologia da Música</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">10</th>
					<td>Teorias, métodos e técnicas em musicoterapia I</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">11</th>
					<td>Musicoterapia – Áreas de atuação e aplicação II</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">12</th>
					<td>Música em musicoterapia</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">13</th>
					<td>Psicopatologia e Saúde Mental</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">14</th>
					<td>Teorias, métodos e técnicas em musicoterapia II</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">15</th>
					<td>Vivências Musicoterápicas II</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">16</th>
