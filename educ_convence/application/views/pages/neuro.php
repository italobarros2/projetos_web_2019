			...
			<div class="row">
				<div class="col-lg-8">
					<div class="fix-device banner_content">
						<h2>
								PÓS-GRADUAÇÃO EM NEUROPSICOPEDAGOGIA <br>
						</h2>
						<p>
							O curso de Neuropsicopedagogia Institucional e Clínica, capacita profissionais da área de Educação e
							saúde para que compreendam o sistema neuronal e amplie seus conhecimentos em torno da aprendizagem de
							diferentes sujeitos e contextos. Conheça o curso e matricule-se!
						</p>
						...
						<div class="search_course_wrap">
							...
							<form action="<?=base_url('processo')?>" class="form_perso form_box justify-content-between w-100" style="padding: 0px" method="post">
								<ul style="list-style-type: none; padding: 0">
									...
									<input type="hidden" value="2" name="curso">
								</ul>
								<button type="submit" class="btn search_course_btn" id="contactButton1" style="position: relative; float: right; bottom: 20px; left: -10px">Baixar</button>
		...
		<div class="row" style="background-color: #09111A; margin-right: 0px;">
			<div class="col-perso col-lg-4">
				<div class="info-block single_feature d-flex flex-row pb-30" style="height: 100%; background-color: #1b1e21">
					...
					<div class="desc">
						...
						<p>
							Com duração de 24 meses e com carga horária de 600h/a, o curso traz uma Matriz Curricular diferenciada voltada para o mercado de trabalho.
						</p>
					</div>
				</div>
			</div>
			<div class="col-perso col-lg-4" id="prob">
				<div class="info-block single_feature d-flex flex-row pb-30" style="height: 100%; background-color: #1b1e21">
					...
					<div class="desc">
						<h4>Aprenda Estratégias</h4>
						<p>
							Você adquire conhecimentos a fim de desenvolver e estimular processos cognitivos fundamentais envolvidos na aprendizagem
						</p>
					</div>
				</div>
			</div>
				...
				<div class="info-block single_feature d-flex flex-row pb-30" style="height: 100%; margin-bottom: 0px">
					...
					<div class="desc">
						<div class="desc">
							...
							<p>
								Os profissionais podem atuar em escolas, centros ou associações educacionais, Organização Não-Governamental (ONGs) e Organizações Sociais Cívicas Públicas (OSCIPs).
							</p>
						</div>
					</div>
				</div>
...
<div class="fact_area_perso fact_area overlay" id="diferencials">
	<div class="container">
		...
		<div class="row">
			...
			<!-- single features -->
			<div class="col-lg-4 col-md-6">
				<div class="single_fact card-perso" style="padding-top: 35px">
					<div class="f_icon" style="margin-bottom: 23px">
						<img src="<?=base_url('static/img/f-icons/icon4.png')?>" alt="">
					</div>
					<h4 style="color:#08A0AD; margin-bottom: 20px">Torne-se protagonista no desenvolvimento de outras vidas</h4>
					<p>Potencialize suas capacitações cognitivas e comunicativas para um melhor desempenho nos objetivos profissionais</p>
				</div>
			</div>
		...
		<div class="row justify-content-center" style="margin-top: 100px">
			<div class="col-lg-6">
				<div class="main_title">
					<h2 style="line-height: 1">Veja o depoimento do professor</h2>
					
					<video width="auto" height="300px" controls style="margin-top: 50px">
						<source src="<?=base_url('static/chamada_neuro.mp4')?>" type="video/mp4">
					</video>
				</div>
			</div>
		</div>
		<div class="row justify-content-center" id="disciplines">
			...
			<table class="table" style="margin-bottom: 50px; text-transform: uppercase;">
				<thead>
				<tr>
					<th scope="col">Nº</th>
				...
				<tr>
					<th scope="row">01</th>
					<td>Introdução a Neuropsicopedagogia Institucional e Clínica</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">02</th>
					<td>Neurofisiologia, Aprendizagem e Plasticidade</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">03</th>
					<td>Fundamentos da Neurologia</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">04</th>
					<td>Transtornos Psiquiátricos na Infância e Adolescência</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">05</th>
					<td>Neurofarmacologia e suas Implicações na Aprendizagem</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">06</th>
					<td>Bases Neurobiológicas da Aprendizagem</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">07</th>
					<td>Avaliação e Intervenção psicomotora</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">08</th>
					<td>Avaliação e Intervenção das Funções Executivas</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">09</th>
					<td>Avaliação e Intervenção em Linguagem - Leitura- Escrita e Matemática</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">10</th>
					<td>Experiências em Neuropsicopedagogia - Diagnósticos e Discussão de casos</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">11</th>
					<td>Laboratório Neuropsicopedagógico</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">12</th>
					<td>Orientação à Atividade Prática clínica</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">13</th>
					<td>Orientação à Atividade Prática – Institucional</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">14</th>
					<td>Condutas Típicas da Educação Inclusiva</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">15</th>
					<td>Música e Neurociência</td>
					<td style="text-align: center">20</td>
				</tr>
				<tr>
					<th scope="row">16</th>
					<td>Processamento da informação: Visual e Auditivo</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">17</th>
				...
				<tr>
					<th scope="row">18</th>
					<td>Atividade Prática - Atendimento ao paciente</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">19</th>
					<td>Planejamento e Estudo do Caso - Atendimento Clínico</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row">20</th>
					<td>Planejamento e Projeto - Atendimento Institucional</td>
					<td style="text-align: center">30</td>
				</tr>
				<tr>
					<th scope="row"></th>
				...
				<div class="row clock_sec clockdiv" id="clockdiv">
					<div class="col-lg-12" style="margin-bottom: 25px">
						...
						<ul style="list-style-type: none; padding: 0; margin-top: 20px">
							...
							<li style="display: inline-block"><a href="https://www.instagram.com/educsobraloficial/"><img style="height: 30px" src="<?=base_url('static/img/insta-icon3.png')?>" alt="fb-icon"></a></li></ul>
					</div>
