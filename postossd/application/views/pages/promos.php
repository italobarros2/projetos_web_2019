<div class="postos_general" style="background: url(<?=base_url('static/images/bg_promo.png')?>) no-repeat; background-size: contain">
		<div class="row">
			<div class="col-lg-10 offset-lg-1">
				<div class="promo-sd">
					<div class="col-lg-12 promo-title pt-fix" style="padding-top: 300px;">
						<div class="row">
				...
				<div class="promo-sd" style="margin-bottom: 40px">
					<div class="col-lg-12 promo-title">
						<div class="row">
							...
							<br>
							<div class="posto_badge template_yellow pl-fix" style="margin-bottom: 30px; font-size: 20px">
					...
					<div class="info-promo-box template_red">
						<div class="col-lg-6">
							...
							<div class="promo-box posto_badge template_yellow pl-fix">
